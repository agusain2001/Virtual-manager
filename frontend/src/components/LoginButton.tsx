...
export default function LoginButton() {
    ...
    return (
        <button
            onClick={login}
            className="flex items-center gap-2 px-4 py-2 bg-slate-800 hover:bg-slate-700 border border-slate-600 text-white rounded-lg transition-all duration-200 hover:shadow-lg hover:shadow-slate-900/50"
        >
